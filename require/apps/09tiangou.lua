local soul = {
    ...
    "昨晚你和朋友打了一晚上游戏，你破天荒的给我看了战绩，虽然我看不懂但是我相信你一定是最厉害的、最棒的。我给你发了好多消息夸你，告诉你我多崇拜你，你回了我一句“啥B”，我翻来覆去思考这是什么意思，Sha[傻]，噢你是说我傻，那B就是Baby的意思了吧，原来你是在叫我傻宝，这么宠溺的语气，我竟一时不敢相信，其实你也是喜欢我的对吧。",
    ...
    "今天发工资了给女神转了3000，她一直以为我一个月只挣三千，其实不是的，我捡垃圾一个月挣一万八，给她转三千剩下一万五给女神雇了五个舔狗，我只是害怕她只有我一个人舔会不开心。",
    "今天你没回我的消息，难得晴天，我翻你倒的垃圾，被我找到了一个避孕套，我知道，他来过，我赶紧把套套拿出来泡水喝，我知道，里面有你的味道。",
    "今天你把我的微信拉黑了，我搜了一下我和你的聊天记录，原来你曾经对我说过晚安wan an，a n爱你，原来你曾经是爱过我的，我太幸福了"..Utils.CQCode_Image("tiangou\\wanan.jpg")
}
return {
    check = function (data)
        return data.msg == "舔狗日志"
    end,
    run = function (data,sendMessage)
        math.randomseed(tostring(os.time()):reverse():sub(1, 6))
        sendMessage(os.date("%Y年%m月XX日 晴").."\r\n"..soul[math.random(1,#soul)])
        return true
    end,
    explain = function ()
        return "[CQ:emoji,id=128054]舔狗日志 用心去感受"
    end
}