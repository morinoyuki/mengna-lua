...
return {
check = function (data)
    return LuaEnvName ~= "private" and not runing and ((data.msg:find("[Jj][Oo][Jj][Oo]") and next and os.time() > next) or (data.msg == "泷泽萝拉哒" and checkCoolDownTime(data,"jojo")))
end,
run = function (data, sendMessage)
    ...
    sys.taskInit(function ()
        nietaRun(data, nieta["泷泽萝拉哒"], sendMessage)
    end)
    return true
end,
explain = function ()
